        ...
        <div className="section-padding">
            <div className="container">
                ...
                <form onSubmit={handleSearch} className="flex items-center gap-3 mb-8 max-w-lg">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            onChange={e => {
                                ...
                                setActiveSearch(e.target.value); // live search
                            }}
                    ...
                    {activeSearch && (
                        <button type="button" onClick={() => { setSearch(''); setActiveSearch(''); }} className="text-sm text-gray-400 hover:text-red-500 transition-colors px-2">
                            Clear
                        </button>
                    )}
                </form>
                ...
                {activeSearch && (
                    <p className="text-sm text-gray-500 mb-6">
                        {filtered.length} result{filtered.length !== 1 ? 's' : ''} for <span className="font-semibold text-secondary">"{activeSearch}"</span>
                    </p>
                )}
                ...
                {!isLoading && filtered.length === 0 && (
                    <div className="text-center py-20">
                        ...
                        <p className="text-gray-400">Try different keywords or <button onClick={() => { setSearch(''); setActiveSearch(''); }} className="text-primary hover:underline">clear the search</button></p>
                    </div>
                )}
